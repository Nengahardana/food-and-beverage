    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          <?php $nomor = 1; ?>
          <?php
          $ambil = mysqli_query($koneksi, 'SELECT pemesanan.*,user.nama_lengkap
                  FROM pemesanan
          ...
          <?php foreach ($result as $result) : ?>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="cetakipa4.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary">Detail Cetak</a>
