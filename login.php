    ...
    <form method="POST" action="">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Masukkan Nomor kamar" name="username">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="password" class="form-control" placeholder="Masukkan Nomor kamar" name="password">
        </div>
      </div>
      <div class="mb-3">
