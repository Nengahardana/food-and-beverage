...
?>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>KOPI</strong> EXPRESS</a>
    ...
    <div class="container">
      ...
      if (isset($_POST['konfirm'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO pemesanan (tanggal_pemesanan, total_belanja,id_user) VALUES ('$tanggal_pemesanan', '$totalbelanja','$id_user')");
        ...
        foreach ($_SESSION["pesanan"] as $id_menu => $jumlah) {
          ...
          $total_awal = $koneksi->query("SELECT * from produk where id_menu=$id_menu ")->fetch_all(MYSQLI_ASSOC);
          $total = $total_awal['jumlah'] - $jumlah;
          $kurangi = mysqli_query($koneksi, "update produk set stok='$total' where id_menu=id_menu  ");
        }
