...
$sql = $koneksi->query("SELECT pemesanan_produk.*,produk.nama_menu,produk.harga
                  ...
                  LEFT JOIN produk ON  pemesanan_produk.id_menu =produk.id_menu where jenis_menu='minuman'")->fetch_all(MYSQLI_ASSOC);


$sql2 = $koneksi->query("SELECT * from produk where jenis_menu='minuman'")->fetch_all(MYSQLI_ASSOC);
...
$pdf->Cell(80);
$pdf->Cell(30, 10, 'LAPORAN PENDAPATAN MINUMAN', 0, 0, 'C');
$pdf->Ln();
